            ...
            <div className="max-w-7xl mx-auto px-8 md:px-16 py-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="lg:col-span-6 space-y-6">
                    ...
                    <div className="flex flex-wrap gap-4 pt-2">
                        ...
                        <a href="resume_saktipardano.pdf" download="Sakti_Pardano_Resume.pdf" className="flex items-center gap-2 border border-black text-black px-6 py-3 rounded-full font-medium hover:bg-gray-50 transition-all">
