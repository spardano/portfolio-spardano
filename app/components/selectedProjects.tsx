...
export default function SelectedProjects() {
  const projectData: Project[] = [
    ...
    },
    {
      ...
      imageSrc:'/selectedProjects/comano.png',
    },
    {
      title: "TravelGO Web",
