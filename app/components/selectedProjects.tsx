...
export default function SelectedProjects() {
  ...
  },
  {
    ...
    myRoleDescription: "I designed to app and Implemented the interactive practice UI using SwiftUI for guided vocal exercises.",
    myRoleDescriptionID: "Saya merancang aplikasi dan mengimplementasikan antarmuka latihan interaktif menggunakan SwiftUI untuk latihan vokal yang terarah.",
    year: 2025,
  ...
  },
  {
    ...
    myRoleDescription: "Implemented Speech-to-Text and make sure the transcription is accurate, I solved the 1 minute audio limit by implementing a local audio chunking system, and integrated Gemini AI API to generate contextually relevant emotional support responses.",
    myRoleDescriptionID: "Mengimplementasikan fitur Speech-to-Text dan memastikan transkripsi akurat, menyelesaikan batasan durasi audio 1 menit dengan sistem pemotongan audio lokal, serta mengintegrasikan API Gemini AI untuk menghasilkan respons dukungan emosional yang relevan secara kontekstual.",
    year: 2024,
